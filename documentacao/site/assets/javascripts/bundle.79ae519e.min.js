...
(() => {
  ...
  var ho = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    P = (e, t) => {
      for (var r in t || (t = {})) Ar.call(t, r) && ho(e, r, t[r]);
      if (Bt) for (var r of Bt(t)) bo.call(t, r) && ho(e, r, t[r]);
      return e;
    };
  var vo = (e, t) => {
    var r = {};
    for (var o in e) Ar.call(e, o) && t.indexOf(o) < 0 && (r[o] = e[o]);
    if (e != null && Bt)
      for (var o of Bt(e)) t.indexOf(o) < 0 && bo.call(e, o) && (r[o] = e[o]);
    return r;
  };
  var Cr = (e, t) => () => (
    ...
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let n of ta(t))
        !Ar.call(e, n) &&
          ...
          _r(e, n, {
            get: () => t[n],
            enumerable: !(o = ea(t, n)) || o.enumerable,
          });
    return e;
  };
  var $t = (e, t, r) => (
  ...
  var xo = Cr((kr, yo) => {
    (function (e, t) {
      typeof kr == 'object' && typeof yo != 'undefined'
        ? t()
      ...
      function e(r) {
        ...
        function c(k) {
          var ut = k.type,
            je = k.tagName;
          return !!(
            (je === 'INPUT' && s[ut] && !k.readOnly) ||
            (je === 'TEXTAREA' && !k.readOnly) ||
            k.isContentEditable
          );
        }
        function p(k) {
          k.classList.contains('focus-visible') ||
            (k.classList.add('focus-visible'),
            k.setAttribute('data-focus-visible-added', ''));
        }
        function l(k) {
          k.hasAttribute('data-focus-visible-added') &&
            (k.classList.remove('focus-visible'),
        ...
        function d(k) {
          a(k.target) && (o || c(k.target)) && p(k.target);
        }
        function v(k) {
          a(k.target) &&
            (k.target.classList.contains('focus-visible') ||
              k.target.hasAttribute('data-focus-visible-added')) &&
            ((n = !0),
        ...
        function S(k) {
          document.visibilityState === 'hidden' && (n && (o = !0), X());
        }
        function X() {
        ...
        function ee(k) {
          (k.target.nodeName && k.target.nodeName.toLowerCase() === 'html') ||
            ((o = !1), re());
        }
  ...
  var ao = Cr((Nt, io) => {
     ...
     */ (function (t, r) {
      typeof Nt == 'object' && typeof io == 'object'
        ? (io.exports = r())
        : typeof define == 'function' && define.amd
          ? define([], r)
          : typeof Nt == 'object'
        ...
        var e = {
            686: function (o, n, i) {
              ...
              function S(q) {
                ...
                ((_.style.fontSize = '12pt'),
                  ...
                  (_.style[C ? 'right' : 'left'] = '-9999px'));
                var D =
                  window.pageYOffset || document.documentElement.scrollTop;
                return (
                  (_.style.top = ''.concat(D, 'px')),
              ...
              var X = function (C, _) {
                  var D = S(C);
                  _.container.appendChild(D);
                  var N = f()(D);
                  return (u('copy'), D.remove(), N);
                },
                re = function (C) {
                  var _ =
              ...
              var ut = function () {
                  ...
                  if (G !== void 0)
                    if (G && k(G) === 'object' && G.nodeType === 1) {
                      if (D === 'copy' && G.hasAttribute('disabled'))
                        throw new Error(
                  ...
                  if (We) return ee(We, { container: N });
                  if (G) return D === 'cut' ? v(G) : ee(G, { container: N });
                },
                je = ut;
              function R(q) {
                '@babel/helpers - typeof';
              ...
              function he(q, C, _) {
                return (C && ce(q.prototype, C), _ && ce(q, _), q);
              }
              function Se(q, C) {
                ...
                ((q.prototype = Object.create(C && C.prototype, {
              ...
              function Qi(q) {
                ...
                return function () {
                  var D = Qt(q),
                    N;
                  if (C) {
                    var G = Qt(this).constructor;
                    N = Reflect.construct(D, arguments, G);
                  } else N = D.apply(this, arguments);
                  return Yi(this, N);
                };
              }
              function Yi(q, C) {
                return C && (R(C) === 'object' || typeof C == 'function')
                  ? C
                  : Bi(q);
              }
              function Bi(q) {
              ...
              function Mr(q, C) {
                var _ = 'data-clipboard-'.concat(q);
                if (C.hasAttribute(_)) return C.getAttribute(_);
              }
              var Ji = (function (q) {
                  Se(_, q);
                  var C = Qi(_);
                    ...
                    he(
                      ...
                      [
                          ...
                          value: function () {
                            ...
                            ((this.action =
                              typeof N.action == 'function'
                                ...
                                : this.defaultAction),
                              (this.target =
                                typeof N.target == 'function'
                                  ? N.target
                                  : this.defaultTarget),
                              (this.text =
                                typeof N.text == 'function'
                                  ? N.text
                                  : this.defaultText),
                              (this.container =
                                R(N.container) === 'object'
                                  ? N.container
                                  : document.body));
                          },
                        },
                        {
                          ...
                          value: function (N) {
                            var G = this;
                            this.listener = p()(N, 'click', function (We) {
                              return G.onClick(We);
                            });
                          },
                        },
                        {
                          key: 'onClick',
                          value: function (N) {
                            var G = N.delegateTarget || N.currentTarget,
                              We = this.action(G) || 'copy',
                              Yt = je({
                                action: We,
                          ...
                          value: function () {
                            var N =
                                arguments.length > 0 && arguments[0] !== void 0
                                  ? arguments[0]
                                  : ['copy', 'cut'],
                              G = typeof N == 'string' ? [N] : N,
                              We = !!document.queryCommandSupported;
                            return (
                              G.forEach(function (Yt) {
                                We = We && !!document.queryCommandSupported(Yt);
                              }),
                              We
                            );
                          },
            ...
            438: function (o, n, i) {
              ...
              function a(l, f, u, d, v) {
                ...
                return (
                  l.addEventListener(u, S, v),
                  {
                    destroy: function () {
                      l.removeEventListener(u, S, v);
                    },
                  }
                );
              }
                ...
                return typeof l.addEventListener == 'function'
                  ...
                  : typeof u == 'function'
                    ...
                    : (typeof l == 'string' &&
                      ...
                      Array.prototype.map.call(l, function (S) {
                        return a(S, f, u, d, v);
                      }));
              }
              function p(l, f, u, d) {
                return function (v) {
                  ((v.delegateTarget = s(v.target, f)),
                    v.delegateTarget && d.call(l, v));
                };
              }
              o.exports = c;
            },
            ...
            370: function (o, n, i) {
              ...
              function c(u, d, v) {
                ...
                if (s.node(u)) return p(u, d, v);
                if (s.nodeList(u)) return l(u, d, v);
                if (s.string(u)) return f(u, d, v);
                throw new TypeError(
              ...
              function p(u, d, v) {
                return (
                  u.addEventListener(d, v),
                  {
                    destroy: function () {
                      u.removeEventListener(d, v);
                    },
                  }
                );
              }
              function l(u, d, v) {
                return (
                  Array.prototype.forEach.call(u, function (S) {
                    S.addEventListener(d, v);
                  }),
                  {
                    destroy: function () {
                      Array.prototype.forEach.call(u, function (S) {
                        S.removeEventListener(d, v);
                      });
                    },
                  }
                );
  ...
  function wo(e, t, r) {
    ...
    function a(d, v) {
      o[d] &&
        ((n[d] = function (S) {
          return new Promise(function (X, re) {
            i.push([d, S, X, re]) > 1 || c(d, S);
          });
        }),
        v && (n[d] = v(n[d])));
    }
...
` +
        ...
        if (!this.closed) {
          ...
          if (s)
            if (((this._parentage = null), Array.isArray(s)))
              try {
                for (var a = Oe(s), c = a.next(); !c.done; c = a.next()) {
                  var p = c.value;
                  p.remove(this);
                }
              } catch (S) {
          ...
          if (f) {
            this._finalizers = null;
            try {
              for (var u = Oe(f), d = u.next(); !d.done; d = u.next()) {
                var v = d.value;
                try {
                  So(v);
                } catch (S) {
  ...
  var xt = {
    setTimeout: function (e, t) {
      ...
      return n != null && n.setTimeout
        ? n.setTimeout.apply(n, B([e, t], K(r)))
        : setTimeout.apply(void 0, B([e, t], K(r)));
    },
  ...
  var Pt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (o.isStopped = !1),
        r ? ((o.destination = r), Xt(r) && r.add(o)) : (o.destination = sa),
        o
      );
    }
    return (
      ...
      (t.prototype.next = function (r) {
        this.isStopped ? Ir(Mo(r), this) : this._next(r);
      }),
  ...
  var na = Function.prototype.bind;
  function Rr(e, t) {
    return na.call(e, t);
  }
  var ia = (function () {
    ...
    bt = (function (e) {
      ...
      function t(r, o, n) {
        ...
        if (I(r) || !r)
          ...
          var a;
          i && De.useDeprecatedNextContext
            ? ((a = Object.create(r)),
              (a.unsubscribe = function () {
                return i.unsubscribe();
              }),
              (s = {
                next: r.next && Rr(r.next, a),
                error: r.error && Rr(r.error, a),
                complete: r.complete && Rr(r.complete, a),
              }))
            : (s = r);
        }
  ...
  function er(e) {
    De.useDeprecatedSynchronousErrorHandling ? _o(e) : Zt(e);
  }
  function aa(e) {
    throw e;
  }
  function Ir(e, t) {
    var r = De.onStoppedNotification;
    r &&
      xt.setTimeout(function () {
        return r(e, t);
      });
  }
  var sa = { closed: !0, next: ge, error: aa, complete: ge };
  var wt = (function () {
  ...
  function Co(e) {
    var t;
    return (t = e != null ? e : De.Promise) !== null && t !== void 0
      ? t
      : Promise;
  }
  function ca(e) {
  ...
  function pa(e) {
    return (e && e instanceof Pt) || (ca(e) && Xt(e));
  }
  function la(e) {
  ...
  var T = (function (e) {
    ...
    return (
      (t.prototype.lift = function (r) {
        var o = new Ho(this, this);
        return ((o.operator = r), o);
      }),
      (t.prototype._throwIfClosed = function () {
        if (this.closed) throw new ko();
      }),
      (t.prototype.next = function (r) {
        var o = this;
        Et(function () {
          ...
          if ((o._throwIfClosed(), !o.isStopped)) {
            ...
            try {
              for (
                var s = Oe(o.currentObservers), a = s.next();
                !a.done;
                a = s.next()
              ) {
                var c = a.value;
      ...
      (t.prototype._innerSubscribe = function (r) {
        ...
        return i || s
          ...
          : ((this.currentObservers = null),
            a.push(r),
            new qe(function () {
              ((o.currentObservers = null), Ze(a, r));
            }));
      }),
  ...
  var Ft = {
    setInterval: function (e, t) {
      ...
      return n != null && n.setInterval
        ? n.setInterval.apply(n, B([e, t], K(r)))
        : setInterval.apply(void 0, B([e, t], K(r)));
    },
  ...
  var St = (function (e) {
    ...
    return (
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          n === void 0 && (n = 0),
          Ft.setInterval(r.flush.bind(r, this), n)
        );
      }),
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          ...
          n !== null && n > 0
            ...
            : (r.actions.push(this),
              r._scheduled ||
                (r._scheduled = Tt.requestAnimationFrame(function () {
      ...
      (t.prototype.recycleAsyncId = function (r, o, n) {
        ...
        o != null &&
          ...
          ((i = s[s.length - 1]) === null || i === void 0 ? void 0 : i.id) !==
            o &&
          (Tt.cancelAnimationFrame(o), (r._scheduled = void 0));
      }),
      t
    );
  })(St);
  var Fo = (function (e) {
    ...
    return (
      (t.prototype.flush = function (r) {
        this._active = !0;
        var o;
        r ? (o = r.id) : ((o = this._scheduled), (this._scheduled = void 0));
        var n = this.actions,
          i;
        r = r || n.shift();
  ...
  function pt(e) {
    return I(Vr(e)) ? e.pop() : void 0;
  }
  function Fe(e) {
    return tr(Vr(e)) ? e.pop() : void 0;
  }
  function rr(e, t) {
    return typeof Vr(e) == 'number' ? e.pop() : t;
  }
  var Lt = function (e) {
  ...
  function ir(e) {
    return (
      Symbol.asyncIterator && I(e == null ? void 0 : e[Symbol.asyncIterator])
    );
  }
  function ar(e) {
  ...
  var sr = fa();
  function cr(e) {
    return I(e == null ? void 0 : e[sr]);
  }
  function pr(e) {
    return wo(this, arguments, function () {
      var r, o, n, i;
  ...
  function ua(e) {
    return new F(function (t) {
      var r = e[wt]();
      if (I(r.subscribe)) return r.subscribe(t);
      throw new TypeError(
  ...
  function ba(e) {
    return new F(function (t) {
      var r, o;
      try {
        for (var n = Oe(e), i = n.next(); !i.done; i = n.next()) {
          var s = i.value;
  ...
  function ga(e, t) {
    ...
    return Eo(this, void 0, void 0, function () {
      ...
      return Gt(this, function (c) {
        switch (c.label) {
          case 0:
            (c.trys.push([0, 5, 6, 11]), (r = To(e)), (c.label = 1));
          case 1:
            return [4, r.next()];
          case 2:
  ...
  function zo(e, t) {
    if (e != null) {
      if (nr(e)) return Uo(e, t);
      if (Lt(e)) return Do(e, t);
      if (or(e)) return Wo(e, t);
      if (ir(e)) return mr(e, t);
      if (cr(e)) return Vo(e, t);
      if (lr(e)) return No(e, t);
    }
    throw ar(e);
  }
  function fe(e, t) {
  ...
  function xa(e, t) {
    return ya(t) ? e.apply(void 0, B([], K(t))) : e(t);
  }
  function lt(e) {
    return m(function (t) {
      return xa(e, t);
  ...
  function Ko(e) {
    if (e.length === 1) {
      var t = e[0];
      if (Ea(t)) return { args: t, keys: null };
      if (Oa(t)) {
        var r = Sa(t);
        return {
  ...
  function Oa(e) {
    return e && typeof e == 'object' && wa(e) === Ta;
  }
  function Qo(e, t) {
  ...
  var La = ['addListener', 'removeListener'],
    ...
    _a = ['on', 'off'];
  function h(e, t, r, o) {
    if ((I(r) && ((o = r), (r = void 0)), o)) return h(e, t, r).pipe(lt(o));
    var n = K(
        ka(e)
          ? Ma.map(function (a) {
              return function (c) {
  ...
  function He(e, t, r) {
    (e === void 0 && (e = 0), r === void 0 && (r = Wr));
    var o = -1;
    return (
      t != null && (tr(t) ? (r = t) : (o = t)),
      new F(function (n) {
        var i = qo(e) ? +e - r.now() : e;
        i < 0 && (i = 0);
        var s = 0;
  ...
  function L() {
    ...
    var r = Fe(e),
      o = rr(e, 1 / 0),
      n = e;
    return n.length ? (n.length === 1 ? U(n[0]) : Mt(o)(fe(n, r))) : y;
  }
  var tt = new F(ge);
  var Ha = Array.isArray;
  function dr(e) {
    return e.length === 1 && Ha(e[0]) ? e[0] : e;
  }
  function g(e, t) {
    return E(function (r, o) {
      var n = 0;
                  ...
                  w(
                    ...
                    function (l) {
                      if (
                        ...
                        (n.next(r ? r.apply(void 0, B([], K(f))) : f),
                          i.some(function (u, d) {
                            return !u.length && s[d];
                          }) && n.complete());
                      }
    ...
    return E(function (t, r) {
      ...
      t.subscribe(
        w(
          r,
          function (p) {
            ((o = !0), (n = p), i || U(e(p)).subscribe((i = w(r, a, c))));
          },
          function () {
        ...
        r.subscribe(
          w(
            ...
            function (s) {
              ...
              i++ % t === 0 && n.push([]);
              try {
                for (var u = Oe(n), d = u.next(); !d.done; d = u.next()) {
                  var v = d.value;
                  (v.push(s),
                    e <= v.length && ((f = f != null ? f : []), f.push(v)));
                }
              } catch (re) {
                a = { error: re };
              } finally {
              ...
              if (f)
                try {
                  for (var S = Oe(f), X = S.next(); !X.done; X = S.next()) {
                    var v = X.value;
                    (Ze(n, v), o.next(v));
                  }
                } catch (re) {
            ...
            function () {
              var s, a;
              try {
                for (var c = Oe(n), p = c.next(); !p.done; p = c.next()) {
                  var l = p.value;
                  o.next(l);
                }
              } catch (f) {
  ...
  function Kr(e, t) {
    return t
      ? function (r) {
          return Ke(t.pipe(Ee(1), oe()), r.pipe(Kr(e)));
        }
      : J(function (r, o) {
          return U(e(r, o)).pipe(Ee(1), en(r));
        });
  }
  function nt(e, t) {
    t === void 0 && (t = pe);
  ...
  function ae() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return function (r) {
      return Ke(r, $.apply(void 0, B([], K(e))));
    };
  }
  function hr(e, t) {
    return t
          ...
          t.subscribe(
            w(
              ...
              function () {
                var n, i;
                try {
                  for (var s = Oe(o), a = s.next(); !a.done; a = s.next()) {
                    var c = a.value;
                    r.next(c);
                  }
                } catch (p) {
  ...
  function rn() {
    ...
    return E(function (n, i) {
      Mt(o)(fe(B([n], K(e)), r)).subscribe(i);
    });
  }
  function Ve() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return rn.apply(void 0, B([], K(e)));
  }
  function vt(e) {
    var t,
      r = 1 / 0,
            ...
            var s = 0,
              ...
              c = function () {
                if ((a == null || a.unsubscribe(), (a = null), o != null)) {
                  var l = typeof o == 'number' ? He(o) : U(o(s)),
                    f = w(i, function () {
                      (f.unsubscribe(), p());
                    });
                  l.subscribe(f);
  ...
  function Ut(e, t) {
    return E(Zo(e, t, arguments.length >= 2, !0));
  }
  function le(e) {
    e === void 0 && (e = {});
    var t = e.connector,
    ...
    return function (p) {
      var l,
        ...
        ee = function () {
          var k = l;
          (re(), k == null || k.unsubscribe());
        };
      return E(function (k, ut) {
        (d++, !S && !v && X());
        var je = (u = u != null ? u : r());
        (ut.add(function () {
          (d--, d === 0 && !S && !v && (f = Br(ee, c)));
          ...
          !l &&
            ...
            ((l = new bt({
              ...
              error: function (R) {
                ((S = !0), X(), (f = Br(re, n, R)), je.error(R));
              },
              complete: function () {
                ((v = !0), X(), (f = Br(re, s)), je.complete());
              },
            })),
            U(k).subscribe(l)));
      })(p);
  ...
  function Br(e, t) {
    ...
    if (t !== !1) {
      ...
      return U(t.apply(void 0, B([], K(r)))).subscribe(n);
    }
  }
  function Z(e, t, r) {
    var o,
  ...
  function O(e, t, r) {
    var o = I(e) || t || r ? { next: e, error: t, complete: r } : e;
    return o
      ? E(function (n, i) {
          var s;
  ...
  function on(e, t) {
    return E(function (r, o) {
      var n = t != null ? t : {},
        ...
        S = function (re) {
          return (f = U(e(re)).subscribe(w(o, d, v)));
        },
        X = function () {
          if (p) {
            p = !1;
            var re = l;
            ((l = null), o.next(re), !u && S(re));
          }
        };
      r.subscribe(
        w(
    ...
    return E(function (o, n) {
      ...
      o.subscribe(
        w(n, function (f) {
          if (c) {
            var u = B([f], K(s));
            n.next(r ? r.apply(void 0, B([], K(u))) : u);
          }
        }),
      );
    });
  ...
  function nn() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return E(function (r, o) {
      rt.apply(void 0, B([r], K(e))).subscribe(o);
    });
  }
  function Xr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return nn.apply(void 0, B([], K(e)));
  }
  function an() {
    let e = new It(1);
    return (
      h(document, 'DOMContentLoaded', { once: !0 }).subscribe(() =>
        e.next(document),
      ),
      e
    );
  ...
  var Ra = L(h(document.body, 'focusin'), h(document.body, 'focusout')).pipe(
    Ae(1),
    Q(void 0),
    m(() => Ne() || document.body),
    Z(1),
  ...
  function it(e, t) {
    return H(() =>
      L(
        h(e, 'mouseenter').pipe(m(() => !0)),
        h(e, 'mouseleave').pipe(m(() => !1)),
      ).pipe(t ? jt((r) => He(+!r * t)) : be, Q(e.matches(':hover'))),
    );
  }
  function sn(e, t) {
    ...
    else if (Array.isArray(t)) for (let r of t) sn(e, r);
  }
  function x(e, t, ...r) {
    ...
    return H(
      () => (
        ...
        L(
          h(t, 'load'),
          h(t, 'error').pipe(
            b(() => Nr(() => new ReferenceError(`Invalid script: ${e}`))),
          ),
        ).pipe(
          m(() => {}),
          A(() => document.head.removeChild(t)),
          Ee(1),
        )
      ),
    );
  ...
  var cn = new T(),
    Ia = H(() =>
      typeof ResizeObserver == 'undefined'
        ? _t('https://unpkg.com/resize-observer-polyfill')
        : $(void 0),
    ).pipe(
      m(() => new ResizeObserver((e) => e.forEach((t) => cn.next(t)))),
      b((e) => L(tt, $(e)).pipe(A(() => e.disconnect()))),
      Z(1),
    );
  function de(e) {
  ...
  function mn(e) {
    return L(h(window, 'load'), h(window, 'resize')).pipe(
      $e(0, ye),
      m(() => Be(e)),
      Q(Be(e)),
    );
  ...
  function Ge(e) {
    return L(h(e, 'scroll'), h(window, 'scroll'), h(window, 'resize')).pipe(
      $e(0, ye),
      m(() => gr(e)),
      Q(gr(e)),
    );
  ...
  var yr = {
    drawer: j('[data-md-toggle=drawer]'),
    search: j('[data-md-toggle=search]'),
  };
  function dn(e) {
    return yr[e].checked;
  }
  function at(e, t) {
    yr[e].checked !== t && yr[e].click();
  }
  function Je(e) {
    let t = yr[e];
    return h(t, 'change').pipe(
      m(() => t.checked),
      Q(t.checked),
    );
  }
  ...
  function Ua() {
    return L(
      h(window, 'compositionstart').pipe(m(() => !0)),
      h(window, 'compositionend').pipe(m(() => !1)),
    ).pipe(Q(!1));
  }
  function hn() {
    let e = h(window, 'keydown').pipe(
      g((t) => !(t.metaKey || t.ctrlKey)),
      m((t) => ({
        mode: dn('search') ? 'search' : 'global',
        type: t.key,
        claim() {
      ...
      g(({ mode: t, type: r }) => {
        if (t === 'global') {
          let o = Ne();
          if (typeof o != 'undefined') return !ja(o, r);
        }
        return !0;
      }),
      le(),
    );
    return Ua().pipe(b((t) => (t ? y : e)));
  }
  function we() {
    return new URL(location.href);
  }
  function st(e, t = !1) {
    if (V('navigation.instant') && !t) {
  ...
  function Wt(e) {
    let t = matchMedia(e);
    return ur((r) => t.addListener(() => r(t.matches))).pipe(Q(t.matches));
  }
  function xn() {
    let e = matchMedia('print');
    return L(
      h(window, 'beforeprint').pipe(m(() => !0)),
      h(window, 'afterprint').pipe(m(() => !1)),
    ).pipe(Q(e.matches));
  }
  function eo(e, t) {
    return e.pipe(b((r) => (r ? t() : y)));
  }
  function to(e, t) {
    return new F((r) => {
  ...
  function Tn() {
    return L(
      h(window, 'scroll', { passive: !0 }),
      h(window, 'resize', { passive: !0 }),
    ).pipe(m(wn), Q(wn()));
  }
  function Sn() {
  ...
  function On() {
    return h(window, 'resize', { passive: !0 }).pipe(m(Sn), Q(Sn()));
  }
  function Ln() {
    return z([Tn(), On()]).pipe(
  ...
  function Mn(e, t = new Worker(e)) {
    let r = Wa(t),
      ...
      n = new T();
    n.subscribe(o);
    let i = o.pipe(oe(), ae(!0));
    return n.pipe(oe(), Ve(r.pipe(W(i))), le());
  }
  var Va = j('#__config'),
    Ct = JSON.parse(Va.textContent);
  Ct.base = `${new URL(Ct.base, we())}`;
  function Te() {
    return Ct;
  }
  function V(e) {
    return Ct.features.includes(e);
  }
  function Me(e, t) {
    return typeof t != 'undefined'
      ? Ct.translations[e].replace('#', t.toString())
      : Ct.translations[e];
  }
  function Ce(e, t = document) {
    return j(`[data-md-component=${e}]`, t);
  }
  function me(e, t = document) {
    return M(`[data-md-component=${e}]`, t);
  }
  function Na(e) {
    let t = j('.md-typeset > :first-child', e);
    return h(t, 'click', { once: !0 }).pipe(
      m(() => j('.md-typeset', e)),
      m((r) => ({ hash: __md_hash(r.innerHTML) })),
    );
  }
  function _n(e) {
    if (!V('announce.dismiss') || !e.childElementCount) return y;
    if (!e.hidden) {
      let t = j('.md-typeset', e);
  ...
  function Pn() {
    return x('nav', { class: 'md-code__nav' });
  }
  var In = $t(ro());
  function oo(e, t) {
    let r = t & 2,
      ...
      n = Object.keys(e.terms)
        .filter((c) => !e.terms[c])
        .reduce((c, p) => [...c, x('del', null, (0, In.default)(p)), ' '], [])
        .slice(0, -1),
      i = Te(),
            ...
            e.tags.map((c) => {
              let p = a
                ? c in a
                  ...
                  : 'md-tag-icon'
                : '';
              return x('span', { class: `md-tag ${p}` }, c);
            }),
          ),
        o > 0 &&
          n.length > 0 &&
  ...
  function Fn(e) {
                ...
                x(
                  ...
                  x(
                    ...
                    c.length > 0 && c.length === 1
                      ? Me('search.result.more.one')
                      : Me('search.result.more.other', c.length),
                  ),
                ),
                ...c.map((l) => oo(l, 1)),
              ),
    ...
    return x('li', { class: 'md-search-result__item' }, p);
  }
  function jn(e) {
    return x(
      'ul',
  ...
  function Wn(e, t) {
    ...
    return (
      ...
      x(
        ...
        x(
          'button',
          { class: 'md-version__current', 'aria-label': Me('select.version') },
          t.title,
          ((o = r.version) == null ? void 0 : o.alias) &&
            t.aliases.length > 0 &&
            x('span', { class: 'md-version__alias' }, t.aliases[0]),
        ),
        x('ul', { class: 'md-version__list' }, e.map(Qa)),
      )
    );
  }
  var Ya = 0;
  function Ba(e, t = 250) {
    let r = z([Ye(e), it(e, t)]).pipe(
        m(([n, i]) => n || i),
        Y(),
      ),
      o = H(() => pn(e)).pipe(
    ...
    return r.pipe(
      Re((n) => n),
      b(() => z([r, o])),
      m(([n, i]) => ({ active: n, offset: i })),
      le(),
    );
  }
  function Vt(e, t, r = 250) {
    let { content$: o, viewport$: n } = t,
      i = `__tooltip2_${Ya++}`;
    return H(() => {
      let s = new T(),
        a = new jr(!1);
      s.pipe(oe(), ae(!1)).subscribe(a);
      let c = a.pipe(
        jt((l) => He(+!l * 250, Dr)),
        Y(),
        b((l) => (l ? o : y)),
      ...
      let p = a.pipe(
        ...
        m(([l, f, { size: u }]) => {
          let d = e.getBoundingClientRect(),
            v = d.width / 2;
          if (f.role === 'tooltip') return { x: v, y: 8 + d.height };
          if (d.y >= u.height / 2) {
            let { height: S } = de(f);
            return { x: v, y: -16 - S };
          } else return { x: v, y: 16 + d.height };
        }),
      );
      return (
        z([c, s, p]).subscribe(([l, { offset: f }, u]) => {
          (l.style.setProperty('--md-tooltip-host-x', `${f.x}px`),
            l.style.setProperty('--md-tooltip-host-y', `${f.y}px`),
            l.style.setProperty('--md-tooltip-x', `${u.x}px`),
            l.style.setProperty('--md-tooltip-y', `${u.y}px`),
            l.classList.toggle('md-tooltip2--top', u.y < 0),
            l.classList.toggle('md-tooltip2--bottom', u.y >= 0));
        }),
        a
          .pipe(
            g((l) => l),
          ...
          .subscribe((l) => {
            let f = de(j(':scope > *', l));
            (l.style.setProperty('--md-tooltip-width', `${f.width}px`),
              l.style.setProperty('--md-tooltip-tail', '0px'));
          }),
        a.pipe(Y(), xe(ye), te(c)).subscribe(([l, f]) => {
          f.classList.toggle('md-tooltip2--active', l);
        }),
        z([a.pipe(g((l) => l)), c]).subscribe(([l, f]) => {
          f.role === 'dialog'
            ? (e.setAttribute('aria-controls', i),
              e.setAttribute('aria-haspopup', 'dialog'))
            : e.setAttribute('aria-describedby', i);
        }),
        a.pipe(g((l) => !l)).subscribe(() => {
  ...
  function Ga(e, t) {
    let r = H(() => z([mn(e), Ge(t)])).pipe(
      m(([{ x: o, y: n }, i]) => {
        let { width: s, height: a } = de(e);
  ...
  function Dn(e, t, { target$: r }) {
    ...
    return H(() => {
      ...
      return (
        ...
        i.pipe($e(16, ye)).subscribe(({ active: a }) => {
  ...
  function Ja(e) {
    let t = Te();
    if (e.tagName !== 'CODE') return [e];
    let r = ['.c', '.c1', '.cm'];
    if (t.annotate && typeof t.annotate == 'object') {
      let o = e.closest('[class|=language]');
      if (o)
        for (let n of Array.from(o.classList)) {
          if (!n.startsWith('language-')) continue;
          let [, i] = n.split('-');
  ...
  function Tr(e, t, { target$: r, print$: o }) {
    ...
    for (let a of Xa(t)) {
      ...
      ue(`:scope > li:nth-child(${c})`, e) &&
        (s.set(c, kn(c, i)), a.replaceWith(s.get(c)));
    }
    return s.size === 0
      ? y
      : H(() => {
          let a = new T(),
            ...
            p = [];
          for (let [l, f] of s)
            p.push([j('.md-typeset', f), j(`:scope > li:nth-child(${l})`, e)]);
          return (
            o.pipe(W(c)).subscribe((l) => {
              ((e.hidden = !l), e.classList.toggle('md-annotation-list', l));
              for (let [f, u] of p) l ? Vn(f, u) : Vn(u, f);
            }),
            L(...[...s].map(([, l]) => Dn(l, t, { target$: r }))).pipe(
              A(() => a.complete()),
              le(),
            )
          );
  ...
  function Nn(e) {
    if (e.nextElementSibling) {
      ...
      if (t.tagName === 'P' && !t.children.length) return Nn(t);
    }
  }
  function zn(e, t) {
    return H(() => {
      let r = Nn(e);
      return typeof r != 'undefined' ? Tr(r, e, t) : y;
    });
  }
  var Kn = $t(ao());
  var Za = 0,
    qn = L(
      h(window, 'keydown').pipe(m(() => !0)),
      L(h(window, 'keyup'), h(window, 'contextmenu')).pipe(m(() => !1)),
    ).pipe(Q(!1), Z(1));
  function Qn(e) {
    if (e.nextElementSibling) {
      let t = e.nextElementSibling;
      if (t.tagName === 'OL') return t;
      if (t.tagName === 'P' && !t.children.length) return Qn(t);
    }
  }
  function es(e) {
    return Le(e).pipe(
      m(({ width: t }) => ({ scrollable: At(e).width > t })),
      ne('scrollable'),
    );
  }
  function Yn(e, t) {
    let { matches: r } = matchMedia('(hover)'),
      o = H(() => {
        ...
        a.id = `__code_${p}`;
        let l = [],
          f = e.closest('.highlight');
        if (f instanceof HTMLElement) {
          let d = Qn(f);
          if (
            typeof d != 'undefined' &&
            (f.classList.contains('annotate') || V('content.code.annotate'))
          ) {
            let v = Tr(d, e, t);
            l.push(
              Le(f).pipe(
                W(i),
                m(({ width: S, height: X }) => S && X),
                Y(),
                b((S) => (S ? v : y)),
              ),
            );
        ...
        let u = M(':scope > span[id]', e);
        if (
          u.length &&
          (e.classList.add('md-code__content'),
          e.closest('.select') ||
            (V('content.code.select') && !e.closest('.no-select')))
        ) {
          let d = +u[0].id.split('-').pop(),
            v = $n();
          (s.push(v), V('content.tooltips') && l.push(Xe(v, { viewport$ })));
          let S = h(v, 'click').pipe(
            Ut((R) => !R, !1),
            O(() => v.blur()),
            le(),
          );
          S.subscribe((R) => {
            v.classList.toggle('md-code__button--active', R);
          });
          let X = fe(u).pipe(J((R) => it(R).pipe(m((se) => [R, se]))));
          S.pipe(b((R) => (R ? X : y))).subscribe(([R, se]) => {
            let ce = ue('.hll.select', R);
            if (ce && !se) ce.replaceWith(...Array.from(ce.childNodes));
            else if (!ce && se) {
              let he = document.createElement('span');
              ((he.className = 'hll select'),
                he.append(...Array.from(R.childNodes).slice(1)),
                R.append(he));
            }
          });
          let re = fe(u).pipe(
            ...
            ee = S.pipe(
              ...
              m(([R, se]) => {
                var he;
                let ce = u.indexOf(R) + d;
                if (se === !1) return [ce, ce];
                {
                  let Se = M('.hll', e).map(
                    (Ue) => u.indexOf(Ue.parentElement) + d,
                  );
                  return (
                    (he = window.getSelection()) == null ||
                      he.removeAllRanges(),
                    [Math.min(ce, ...Se), Math.max(ce, ...Se)]
                  );
                }
              }),
            ),
            k = Zr(y).pipe(g((R) => R.startsWith(`__codelineno-${p}-`)));
          (k.subscribe((R) => {
            let [, , se] = R.split('-'),
              ce = se.split(':').map((Se) => +Se - d + 1);
            ce.length === 1 && ce.push(ce[0]);
            for (let Se of M('.hll:not(.select)', e))
              Se.replaceWith(...Array.from(Se.childNodes));
            let he = u.slice(ce[0] - 1, ce[1]);
            for (let Se of he) {
              let Ue = document.createElement('span');
              ((Ue.className = 'hll'),
                Ue.append(...Array.from(Se.childNodes).slice(1)),
                Se.append(Ue));
            }
          }),
            k.pipe(Ee(1), xe(pe)).subscribe((R) => {
              if (R.includes(':')) {
                let se = document.getElementById(R.split(':')[0]);
                se &&
                  setTimeout(() => {
                    let ce = se,
                      he = -64;
                    for (; ce !== document.body; )
                      ((he += ce.offsetTop), (ce = ce.offsetParent));
                    window.scrollTo({ top: he });
                  }, 1);
              }
            }));
          let je = fe(M('a[href^="#__codelineno"]', f))
            .pipe(
              J((R) =>
                h(R, 'click').pipe(
                  O((se) => se.preventDefault()),
            ...
            .pipe(
              ...
              te(qn),
              m(([R, se]) => {
                let he = +j(`[id="${R.hash.slice(1)}"]`)
                  .parentElement.id.split('-')
                  .pop();
                if (se === !1) return [he, he];
                {
                  let Se = M('.hll', e).map(
                    (Ue) => +Ue.parentElement.id.split('-').pop(),
                  );
                  return [Math.min(he, ...Se), Math.max(he, ...Se)];
                }
              }),
            );
          L(ee, je).subscribe((R) => {
            let se = `#__codelineno-${p}-`;
            (R[0] === R[1] ? (se += R[0]) : (se += `${R[0]}:${R[1]}`),
              history.replaceState({}, '', se),
              window.dispatchEvent(
                new HashChangeEvent('hashchange', {
                  newURL:
                    window.location.origin + window.location.pathname + se,
        ...
        if (
          Kn.default.isSupported() &&
          (e.closest('.copy') ||
            (V('content.code.copy') && !e.closest('.no-copy')))
        ) {
          let d = Hn(a.id);
          (s.push(d), V('content.tooltips') && l.push(Xe(d, { viewport$ })));
        }
        if (s.length) {
          let d = Pn();
          (d.append(...s), a.insertBefore(d, e));
        }
        return es(e).pipe(
          O((d) => n.next(d)),
          A(() => n.complete()),
  ...
  function rs(e) {
    ...
    for (; o && !(o instanceof HTMLHeadingElement); )
      (r.push(o), (o = o.nextElementSibling));
    return r;
  }
  function os(e, t) {
    for (let r of M('[href], [src]', e))
      for (let o of ['href', 'src']) {
        let n = r.getAttribute(o);
        if (n && !/^(?:[a-z]+:)?\/\//i.test(n)) {
          r[o] = new URL(r.getAttribute(o), t).toString();
          break;
        }
      }
    for (let r of M('[name^=__], [for]', e))
      for (let o of ['id', 'for', 'name']) {
        let n = r.getAttribute(o);
        n && r.setAttribute(o, `${n}$preview_${Gn}`);
      }
    return (Gn++, $(e));
  }
  function Jn(e, t) {
    let { sitemap$: r } = t;
    if (!(e instanceof HTMLAnchorElement)) return y;
    if (!(V('navigation.instant.preview') || e.hasAttribute('data-preview')))
      return y;
    e.removeAttribute('title');
    let o = z([Ye(e), it(e)]).pipe(
      m(([i, s]) => i || s),
      Y(),
      g((i) => i),
    );
    return rt([r, o])
      .pipe(
        b(([i]) => {
          let s = new URL(e.href);
          return ((s.search = s.hash = ''), i.has(`${s}`) ? $(s) : y);
        }),
        b((i) => xr(i).pipe(b((s) => os(s, i)))),
        b((i) => {
          let s = e.hash ? `article [id="${e.hash.slice(1)}"]` : 'article h1',
            a = ue(s, i);
          return typeof a == 'undefined' ? y : $(rs(a));
        }),
      )
      .pipe(
        b((i) => {
          let s = new F((a) => {
            let c = wr(...i);
            return (a.next(c), document.body.append(c), () => c.remove());
          });
          return Vt(e, P({ content$: s }, t));
        }),
      );
  }
  var Xn =
  ...
  function as() {
    return typeof mermaid == 'undefined' || mermaid instanceof Element
      ? _t('https://unpkg.com/mermaid@11/dist/mermaid.min.js')
      : $(void 0);
  }
  function Zn(e) {
    return (
  ...
  var ei = x('table');
  function ti(e) {
    return (e.replaceWith(ei), ei.replaceWith(Un(e)), $({ ref: e }));
  }
  function ss(e) {
    let t = e.find((r) => r.checked) || e[0];
    return L(
      ...e.map((r) => h(r, 'change').pipe(m(() => j(`label[for="${r.id}"]`)))),
    ).pipe(
      Q(j(`label[for="${t.id}"]`)),
      m((r) => ({ active: r })),
    );
  ...
  function ri(e, { viewport$: t, target$: r }) {
    ...
    return (
      ...
      H(() => {
        ...
        (z([a, Le(e), mt(e)])
          ...
          z([Ge(o), Le(o)])
            ...
            .subscribe(([p, l]) => {
              let f = At(o);
              ((i.hidden = p.x < 16),
                (s.hidden = p.x > f.width - l.width - 16));
            }),
          L(h(i, 'click').pipe(m(() => -1)), h(s, 'click').pipe(m(() => 1)))
            .pipe(W(c))
            .subscribe((p) => {
              let { width: l } = de(o);
        ...
        return (
          V('content.tabs.link') &&
            a.pipe(Ie(1), te(t)).subscribe(([{ active: p }, { offset: l }]) => {
              let f = p.innerText.trim();
              if (p.hasAttribute('data-md-switching'))
                p.removeAttribute('data-md-switching');
              else {
                let u = e.offsetTop - l.y;
                for (let v of M('[data-tabs]'))
                  for (let S of M(':scope > input', v)) {
                    let X = j(`label[for="${S.id}"]`);
                    if (X !== p && X.innerText.trim() === f) {
                      (X.setAttribute('data-md-switching', ''), S.click());
                      break;
                    }
                  }
          ...
          a.pipe(W(c)).subscribe(() => {
            for (let p of M('audio, video', e))
              p.offsetWidth && p.autoplay
                ? p.play().catch(() => {})
                : p.pause();
          }),
          ss(n).pipe(
  ...
  function oi(e, t) {
    let { viewport$: r, target$: o, print$: n } = t;
    return L(
      ...M('.annotate:not(.highlight)', e).map((i) =>
        zn(i, { target$: o, print$: n }),
      ),
      ...M('pre:not(.mermaid) > code', e).map((i) =>
        Yn(i, { target$: o, print$: n }),
      ),
      ...M('a', e).map((i) => Jn(i, t)),
      ...M('pre.mermaid', e).map((i) => Zn(i)),
      ...M('table:not([class])', e).map((i) => ti(i)),
      ...M('details', e).map((i) => Bn(i, { target$: o, print$: n })),
      ...M('[data-tabs]', e).map((i) => ri(i, { viewport$: r, target$: o })),
      ...M('[title]:not([data-preview])', e)
        .filter(() => V('content.tooltips'))
        .map((i) => Xe(i, { viewport$: r })),
      ...M('.footnote-ref', e)
        .filter(() => V('content.footnote.tooltips'))
        .map((i) =>
          Vt(i, {
            content$: new F((s) => {
              let a = new URL(i.href).hash.slice(1),
                c = Array.from(
                  document.getElementById(a).cloneNode(!0).children,
                ),
                p = wr(...c);
              return (s.next(p), document.body.append(p), () => p.remove());
            }),
            viewport$: r,
          }),
        ),
  ...
  function ls(e, t) {
    ...
    let o = vr(t),
      n = typeof o != 'undefined' ? Ge(o) : $({ x: 0, y: 0 }),
      i = L(Ye(t), it(t)).pipe(Y());
    return z([i, n]).pipe(
      m(([s, a]) => {
        let { x: c, y: p } = Be(t),
          l = de(t),
    ...
    return (
      ...
      H(() => {
        ...
        return (
          ...
          i.pipe($e(16, ye)).subscribe(({ active: s }) => {
  ...
  function si(e, { header$: t, main$: r }) {
    return H(() => {
      let o = new T(),
        n = o.pipe(oe(), ae(!0));
      o.pipe(ne('active'), Pe(t)).subscribe(
        ([{ active: s }, { hidden: a }]) => {
          (e.classList.toggle('md-header--shadow', s && !a), (e.hidden = a));
        },
      );
      let i = fe(M('[title]', e)).pipe(
        g(() => V('content.tooltips')),
        J((s) => ii(s)),
      );
      return (
        r.subscribe(o),
  ...
  function fs(e, { viewport$: t, header$: r }) {
    return Er(e, { viewport$: t, header$: r }).pipe(
      m(({ offset: { y: o } }) => {
        let { height: n } = de(e);
        return { active: n > 0 && o >= n };
      }),
      ne('active'),
    );
  }
  ...
  function li(e) {
    ...
    let n = Wt('(prefers-color-scheme: light)');
    return H(() => {
      let i = new T();
      return (
        i.subscribe((s) => {
        ...
        h(e, 'keydown')
          ...
          .subscribe(({ index: s }) => {
            ((s = (s + 1) % t.length), t[s].click(), t[s].focus());
          }),
        i
          .pipe(
            m(() => {
  ...
  function ds(e, t) {
    let r = new Map();
    for (let o of M('url', e)) {
      let n = j('loc', o),
        i = [fi(new URL(n.textContent), t)];
      r.set(`${i[0]}`, i);
      for (let s of M('[rel=alternate]', o)) {
        let a = s.getAttribute('href');
        a != null && i.push(fi(new URL(a), t));
      }
    }
    return r;
  }
  function kt(e) {
    return En(new URL('sitemap.xml', e)).pipe(
      m((t) => ds(t, new URL(e))),
      ve(() => $(new Map())),
      le(),
    );
  ...
  function ui({ document$: e }) {
    ...
    (e
      .pipe(
        b(() => M('link[rel=alternate]')),
        m((r) => new URL(r.href)),
        g((r) => !t.has(r.toString())),
        J((r) =>
          kt(r).pipe(
            m((o) => [r, o]),
            ve(() => y),
      ...
      .subscribe(([r, o]) => {
        t.set(r.toString().replace(/\/$/, ''), o);
      }),
      h(document.body, 'click')
        .pipe(
          g((r) => !r.metaKey && !r.ctrlKey),
          b((r) => {
            if (r.target instanceof Element) {
              let o = r.target.closest('a');
              if (o && !o.target) {
                let n = [...t].find(([f]) => o.href.startsWith(`${f}/`));
                if (typeof n == 'undefined') return y;
                let [i, s] = n,
                  a = we();
                if (a.href.startsWith(i)) return y;
                let c = Te(),
                  p = a.href.replace(c.base, '');
                p = `${i}/${p}`;
                let l = s.has(p.split('#')[0])
                  ? new URL(p, c.base)
                  : new URL(i);
  ...
  function di({ alert$: e }) {
    co.default.isSupported() &&
      new F((t) => {
        new co.default('[data-clipboard-target], [data-clipboard-text]', {
          text: (r) =>
            r.getAttribute('data-clipboard-text') ||
            hs(j(r.getAttribute('data-clipboard-target'))),
        ...
        .pipe(
          ...
          m(() => Me('clipboard.copied')),
        )
        .subscribe(e);
  }
  function hi(e, t) {
    if (!(e.target instanceof Element)) return y;
    let r = e.target.closest('a');
    if (r === null) return y;
    if (r.target || e.metaKey || e.ctrlKey) return y;
    let o = new URL(r.href);
    return (
      (o.search = o.hash = ''),
      t.has(`${o}`) ? (e.preventDefault(), $(r)) : y
    );
  }
  function bi(e) {
    let t = new Map();
    for (let r of M(':scope > *', e.head)) t.set(r.outerHTML, r);
    return t;
  }
  function vi(e) {
    for (let t of M('[href], [src]', e))
  ...
  function bs(e) {
    for (let o of [
      ...
      ...(V('navigation.tabs.sticky') ? ['[data-md-component=tabs]'] : []),
    ]) {
      let n = ue(o),
        i = ue(o, e);
    ...
    return Ke(M('script', r)).pipe(
      b((o) => {
        ...
        } else return ((n.textContent = o.textContent), o.replaceWith(n), y);
      }),
      oe(),
      ae(document),
    );
  ...
  function gi({ sitemap$: e, location$: t, viewport$: r, progress$: o }) {
    if (location.protocol === 'file:') return y;
    $(document).subscribe(vi);
    let n = h(document.body, 'click').pipe(
        Pe(e),
        b(([a, c]) => hi(a, c)),
        m(({ href: a }) => new URL(a)),
        le(),
      ),
      i = h(window, 'popstate').pipe(m(we), le());
    (n.pipe(te(r)).subscribe(([a, { offset: c }]) => {
      (history.replaceState(c, ''), history.pushState(null, '', a));
    }),
      L(n, i).subscribe(t));
    let s = t.pipe(
      ne('pathname'),
      b((a) => xr(a, { progress$: o }).pipe(ve(() => (st(a, !0), y)))),
      b(vi),
      b(bs),
      le(),
    );
    return (
      L(
        ...
        t.pipe(
          Y((a, c) => a.pathname === c.pathname && a.hash === c.hash),
          b(() => n),
          O(() => history.back()),
        ),
      ).subscribe((a) => {
        var c, p;
        history.state !== null || !a.hash
          ? window.scrollTo(
              0,
              (p = (c = history.state) == null ? void 0 : c.y) != null ? p : 0,
            )
      ...
      r.pipe(ne('offset'), Ae(100)).subscribe(({ offset: a }) => {
        history.replaceState(a, '');
      }),
      V('navigation.instant.prefetch') &&
        L(h(document.body, 'mousemove'), h(document.body, 'focusin'))
          .pipe(
            Pe(e),
            b(([a, c]) => hi(a, c)),
            Ae(25),
  ...
  function xi(e) {
    let t = e.separator
        ...
        .join('|'),
      r = new RegExp(t, 'img'),
      o = (n, i, s) => `${i}<mark data-md-highlight>${s}</mark>`;
    return (n) => {
      n = n
        .replace(/[\s*+\-:~^]+/g, ' ')
        .replace(/&/g, '&amp;')
        .trim();
      let i = new RegExp(
        `(^|${e.separator}|)(${n.replace(/[|\\{}()[\]^$+*?.-]/g, '\\$&').replace(r, '|')})`,
        'img',
      );
      return (s) =>
        (0, yi.default)(s)
  ...
  function Ei(e, t) {
    let r = Mn(e);
    return (
      L($(location.protocol !== 'file:'), Je('search'))
        .pipe(
          Re((o) => o),
          b(() => t),
        )
        .subscribe(({ config: o, docs: n }) =>
          r.next({
            ...
            data: {
              config: o,
              docs: n,
              options: { suggest: V('search.suggest') },
            },
          }),
        ),
      r
  ...
  function wi(e) {
    var l;
    let {
        selectedVersionSitemap: t,
        selectedVersionBaseURL: r,
        currentLocation: o,
        currentBaseURL: n,
      } = e,
      i = (l = po(n)) == null ? void 0 : l.pathname;
    if (i === void 0) return;
    let s = ys(o.pathname, i);
    if (s === void 0) return;
    let a = Es(t.keys());
    if (!t.has(a)) return;
    let c = po(s, a);
    if (!c || !t.has(c.href)) return;
    let p = po(s, r);
    if (p) return ((p.hash = o.hash), (p.search = o.search), p);
  }
  function po(e, t) {
    try {
      return new URL(e, t);
  ...
  function Es(e) {
    let t;
    for (let r of e) t === void 0 ? (t = r) : (t = t.slice(0, xs(t, r)));
    return t != null ? t : '';
  }
  function Ti({ document$: e }) {
    let t = Te(),
      r = ze(new URL('../versions.json', t.base)).pipe(ve(() => y)),
      o = r.pipe(
        m((n) => {
          let [, i] = t.base.match(/([^/]+)\/?$/);
          return (
    ...
    (r
      .pipe(
        m(
          (n) =>
            new Map(
              n.map((i) => [`${new URL(`../${i.version}/`, t.base)}`, i]),
            ),
        ),
        b((n) =>
          h(document.body, 'click').pipe(
      ...
      .subscribe((n) => st(n, !0)),
      z([r, o]).subscribe(([n, i]) => {
        j('.md-header__topic').appendChild(Wn(n, i));
      }),
      e.pipe(b(() => o)).subscribe((n) => {
        var a;
        let i = new URL(t.base),
          s = __md_get('__outdated', sessionStorage, i);
        if (s === null) {
          s = !0;
          ...
          __md_set('__outdated', s, sessionStorage, i);
        }
        if (s) for (let c of me('outdated')) c.hidden = !1;
      }));
  }
  function ws(e, { worker$: t }) {
    let { searchParams: r } = we();
    r.has('q') &&
      (at('search', !0),
      (e.value = r.get('q')),
      e.focus(),
    ...
    let o = Ye(e),
      n = L(t.pipe(Re(zt)), h(e, 'keyup'), o).pipe(
        m(() => e.value),
        Y(),
      );
    return z([n, o]).pipe(
  ...
  function Si(e, { worker$: t }) {
    let r = new T(),
      o = r.pipe(oe(), ae(!0));
    (z([t.pipe(Re(zt)), r], (i, s) => s)
      .pipe(ne('value'))
      .subscribe(({ value: i }) => t.next({ type: 2, data: i })),
      r.pipe(ne('focus')).subscribe(({ focus: i }) => {
        i && at('search', i);
      }),
      h(e.form, 'reset')
        .pipe(W(o))
        .subscribe(() => e.focus()));
    let n = j('header [for=__search]');
    return (
      h(n, 'click').subscribe(() => e.focus()),
      ws(e, { worker$: t }).pipe(
        O((i) => r.next(i)),
        A(() => r.complete()),
        m((i) => P({ ref: e }, i)),
  ...
  function Oi(e, { worker$: t, query$: r }) {
    let o = new T(),
      n = un(e.parentElement).pipe(g(Boolean)),
      i = e.parentElement,
      s = j(':scope > :first-child', e),
      a = j(':scope > :last-child', e);
    (Je('search').subscribe((l) => {
      (a.setAttribute('role', l ? 'list' : 'presentation'), (a.hidden = !l));
    }),
      o
        .pipe(te(r), Gr(t.pipe(Re(zt))))
        .subscribe(([{ items: l }, { value: f }]) => {
          switch (l.length) {
            case 0:
              s.textContent = f.length
                ? Me('search.result.none')
                : Me('search.result.placeholder');
              break;
            case 1:
              s.textContent = Me('search.result.one');
              break;
            default:
              let u = br(l.length);
              s.textContent = Me('search.result.other', u);
          }
        }));
    let c = o.pipe(
      O(() => (a.innerHTML = '')),
  ...
  function Mi(e, { worker$: t, keyboard$: r }) {
    let o = new T(),
      n = Ce('search-query'),
      i = L(h(n, 'keydown'), h(n, 'focus')).pipe(
        xe(pe),
        m(() => n.value),
        Y(),
      );
  ...
  function _i(e, { index$: t, keyboard$: r }) {
    ...
    try {
        ...
        r.pipe(g(({ mode: c }) => c === 'search')).subscribe((c) => {
          ...
          switch (c.type) {
            case 'Enter':
              if (p === i) {
                let l = new Map();
                for (let f of M(':first-child [href]', s)) {
      ...
      let a = Si(i, { worker$: n });
      return L(a, Oi(s, { worker$: n, query$: a })).pipe(
        Ve(
          ...me('search-share', e).map((c) => Li(c, { query$: a })),
          ...me('search-suggest', e).map((c) =>
            Mi(c, { worker$: n, keyboard$: r }),
          ),
        ),
      );
    } catch (n) {
      return ((e.hidden = !0), tt);
    }
  }
  function Ai(e, { index$: t, location$: r }) {
    return z([
      ...
      m(([o, n]) => xi(o.config)(n.searchParams.get('h'))),
      m((o) => {
        var s;
        let n = new Map(),
        ...
        for (let [a, c] of n) {
          let { childNodes: p } = x('span', null, c);
  ...
  function lo(e, o) {
    var n = o,
      { header$: t } = n,
      r = vo(n, ['header$']);
    let i = j('.md-sidebar__scrollwrap', e),
      { y: s } = Be(i);
    return H(() => {
      let a = new T(),
        c = a.pipe(oe(), ae(!0)),
      ...
      return (
        ...
        fe(M('label[tabindex]', e))
          ...
          .subscribe((l) => {
            let f = j(`[id="${l.htmlFor}"]`);
            j(`[aria-labelledby="${l.id}"]`).setAttribute(
              'aria-expanded',
              `${f.checked}`,
            );
          }),
  ...
  function ki(e, t) {
    ...
    return rt(
      ze(`${r}/releases/permalink/latest`).pipe(
        ve(() => y),
        m(({ tag_name: o }) => ({ version: o })),
        Qe({}),
      ),
      ze(r).pipe(
        ve(() => y),
  ...
  function Ms(e, { viewport$: t, header$: r }) {
    return Le(document.body).pipe(
      b(() => Er(e, { header$: r, viewport$: t })),
  ...
  function Pi(e, t) {
    return H(() => {
      ...
      return (
        ...
        (V('navigation.tabs.sticky') ? $({ hidden: !1 }) : Ms(e, t)).pipe(
          O((o) => r.next(o)),
          A(() => r.complete()),
          m((o) => P({ ref: e }, o)),
        )
          ...
          H(() => {
            ...
            return $(
              [...o].reduce((p, [l, f]) => {
                ...
                for (; d; d = d.offsetParent) u += d.offsetTop;
            ...
            b(([c, p]) =>
              t.pipe(
                Ut(
                  ([l, f], { offset: { y: u }, size: d }) => {
                    let v = u + d.height >= Math.floor(a.height);
                    for (; f.length; ) {
                      let [, S] = f[0];
                      if (S - p < u || v) l = [...l, f.shift()];
                      else break;
                    }
                    for (; l.length; ) {
                      let [, S] = l[l.length - 1];
                      if (S - p >= u && !v) f = [l.pop(), ...f];
                      else break;
                    }
                    return [l, f];
                  },
        ...
        i.pipe(
          ...
          if (l.offsetHeight) {
            ...
            if (typeof f != 'undefined') {
              let u = l.offsetTop - f.offsetTop,
                { height: d } = de(f);
              f.scrollTo({ top: u - d / 2, behavior: p });
            }
          }
        });
      }
      return (
        V('navigation.tracking') &&
          t
            .pipe(
              W(s),
              ne('offset'),
  ...
  function Ii(e, { viewport$: t, header$: r, main$: o, target$: n }) {
    ...
    return (
      ...
      r.pipe(W(s), ne('height')).subscribe(({ height: a }) => {
        e.style.top = `${a + 16}px`;
      }),
      h(e, 'click').subscribe((a) => {
        (a.preventDefault(), window.scrollTo({ top: 0 }));
      }),
      As(e, { viewport$: t, main$: o, target$: n }).pipe(
        O((a) => i.next(a)),
        A(() => i.complete()),
        m((a) => P({ ref: e }, a)),
      )
  ...
  function Fi({ document$: e, viewport$: t }) {
    (e
      .pipe(
        ...
        g((r) => r.offsetWidth < r.scrollWidth),
        J((r) => {
          let o = r.innerText,
            n = r.closest('a') || r;
          return (
  ...
  function ji({ document$: e, tablet$: t }) {
    e.pipe(
      ...
      J((r) =>
        h(r, 'change').pipe(
          Jr(() => r.classList.contains('md-toggle--indeterminate')),
          m(() => r),
        ),
      ),
      te(t),
  ...
  function Ui({ document$: e }) {
    e.pipe(
      b(() => M('[data-md-scrollfix]')),
      O((t) => t.removeAttribute('data-md-scrollfix')),
      g(Cs),
      J((t) => h(t, 'touchstart').pipe(m(() => t))),
    ).subscribe((t) => {
      let r = t.scrollTop;
      r === 0
        ? (t.scrollTop = 1)
  ...
  function ks() {
    return location.protocol === 'file:'
      ? _t(`${new URL('search/search_index.js', Or.base)}`).pipe(
          m(() => __index),
          Z(1),
        )
      : ze(new URL('search/search_index.json', Or.base));
  }
  ...
  var ct = an(),
    ...
    mo = hn(),
    ke = Ln(),
    Lr = Wt('(min-width: 60em)'),
    Vi = Wt('(min-width: 76.25em)'),
    Ni = xn(),
    Or = Te(),
    zi = document.forms.namedItem('search') ? ks() : tt,
    fo = new T();
  di({ alert$: fo });
  ui({ document$: ct });
  var uo = new T(),
    qi = kt(Or.base);
  V('navigation.instant') &&
    gi({ sitemap$: qi, location$: Kt, viewport$: ke, progress$: uo }).subscribe(
      ct,
    );
  var Di;
  ((Di = Or.version) == null ? void 0 : Di.provider) === 'mike' &&
    Ti({ document$: ct });
  L(Kt, Ht)
    .pipe(nt(125))
    .subscribe(() => {
      (at('drawer', !1), at('search', !1));
    });
  mo.pipe(g(({ mode: e }) => e === 'global')).subscribe((e) => {
    switch (e.type) {
      case 'p':
      case ',':
  ...
  Fi({ viewport$: ke, document$: ct });
  ji({ document$: ct, tablet$: Lr });
  Ui({ document$: ct });
  Wi({ viewport$: ke, tablet$: Lr });
  var ft = ai(Ce('header'), { viewport$: ke }),
    qt = ct.pipe(
      m(() => Ce('main')),
      b((e) => pi(e, { viewport$: ke, header$: ft })),
      Z(1),
    ),
    Hs = L(
      ...me('consent').map((e) => An(e, { target$: Ht })),
      ...me('dialog').map((e) => ni(e, { alert$: fo })),
      ...me('palette').map((e) => li(e)),
      ...me('progress').map((e) => mi(e, { progress$: uo })),
      ...me('search').map((e) => _i(e, { index$: zi, keyboard$: mo })),
      ...me('source').map((e) => $i(e)),
    ),
    $s = H(() =>
      L(
        ...me('announce').map((e) => _n(e)),
        ...me('content').map((e) =>
          oi(e, { sitemap$: qi, viewport$: ke, target$: Ht, print$: Ni }),
        ),
        ...me('content').map((e) =>
          V('search.highlight') ? Ai(e, { index$: zi, location$: Kt }) : y,
        ),
        ...me('header').map((e) =>
          si(e, { viewport$: ke, header$: ft, main$: qt }),
        ),
        ...me('header-title').map((e) => ci(e, { viewport$: ke, header$: ft })),
        ...me('sidebar').map((e) =>
          e.getAttribute('data-md-type') === 'navigation'
            ? eo(Vi, () => lo(e, { viewport$: ke, header$: ft, main$: qt }))
            : eo(Lr, () => lo(e, { viewport$: ke, header$: ft, main$: qt })),
        ),
        ...me('tabs').map((e) => Pi(e, { viewport$: ke, header$: ft })),
        ...me('toc').map((e) =>
          Ri(e, { viewport$: ke, header$: ft, main$: qt, target$: Ht }),
        ),
        ...me('top').map((e) =>
          Ii(e, { viewport$: ke, header$: ft, main$: qt, target$: Ht }),
        ),
      ),
    ),
    Ki = ct.pipe(
