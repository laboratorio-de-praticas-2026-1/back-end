      ...
      (e.ar.stemmer = (function () {
        ...
        return (
          ...
          (e.cleanWord = function () {
            ...
            return (
              (e.word = e.word.replace(new RegExp('ـ', 'g'), '')),
              !!r.test('')
            );
          }),
          ...
          (e.patternCheck = function (r) {
            for (var t = 0; t < r.length; t++) {
              for (var c = !0, l = 0; l < r[t].pt.length; l++) {
                var n = r[t].pt[l].c.split(','),
                  o = !1;
                if (
                  (n.forEach(function (c) {
                    e.word[r[t].pt[l].l] == c && (o = !0);
                  }),
                  !o)
                ) {
                  c = !1;
          ...
          (e.wordCheck = function () {
            ...
            for (t = 0; 5 == e.word.length && !e.result && t < n.length; )
              (n[t](), t++);
            var o = [
              e.checkPattern43,
              e.removeSuf1,
            ...
            for (t = 0; 4 == e.word.length && !e.result && t < o.length; )
              (o[t](), t++);
            return !0;
          }),
