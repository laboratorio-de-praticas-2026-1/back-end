...
(() => {
  ...
  var K = Math.pow,
    X = (t, e, r) =>
      e in t
        ? G(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r })
        : (t[e] = r),
    _ = (t, e) => {
  ...
  var Pe = (t, e, r) => (
    ...
    we(
      e || !t || !t.__esModule
        ? G(r, 'default', { value: t, enumerable: !0 })
        : r,
      t,
    )
  );
...
`,
          ...
          for (
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                ...
                (g in s.node.edges
                  ? (l = s.node.edges[g])
                  : ((l = new t.TokenSet()), (s.node.edges[g] = l)),
              ...
              for (var f = s[c], g = 0; g < u; g++) {
                ...
                if (l == f || f == '*') {
                  var m = n.node.edges[l],
                    ...
                    d = void 0;
                  (l in n.output.edges
                    ? ((d = n.output.edges[l]), (d.final = d.final || v))
                    : ((d = new t.TokenSet()),
                      (d.final = v),
                      (n.output.edges[l] = d)),
                    i.push({ qNode: x, output: d, node: m }));
                }
              }
          }
          return r;
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (var u = 0; u < r.clauses.length; u++) {
            var c = r.clauses[u],
              ...
              g = t.Set.empty;
            c.usePipeline
              ? (f = this.pipeline.runString(c.term, { fields: c.fields }))
              : (f = [c.term]);
            for (var l = 0; l < f.length; l++) {
              ...
              for (var b = 0; b < v.length; b++)
                for (
                  var E = v[b], w = this.invertedIndex[E], R = w._index, d = 0;
                  d < c.fields.length;
                  d++
                ) {
                  var y = c.fields[d],
                  ...
                  if (
                    (i[y].upsert(R, c.boost, function (ye, me) {
                      return ye + me;
                    }),
                    !s[D])
                  ) {
          ...
          for (
            var A = t.Set.complete, I = t.Set.empty, u = 0;
            u < this.fields.length;
            u++
          ) {
            var y = this.fields[u];
            (o[y] && (A = A.intersect(o[y])), a[y] && (I = I.union(a[y])));
          }
          var h = Object.keys(n),
            S = [],
        ...
        (t.Builder.prototype.add = function (e, r) {
          ...
          for (var s = 0; s < i.length; s++) {
            ...
            for (var m = 0; m < f.length; m++) {
              ...
              this.invertedIndex[x][o][n] == null &&
                (this.invertedIndex[x][o][n] = Object.create(null));
              for (var y = 0; y < this.metadataWhitelist.length; y++) {
                var b = this.metadataWhitelist[y],
                  E = x.metadata[b];
                (this.invertedIndex[x][o][n][b] == null &&
                  (this.invertedIndex[x][o][n][b] = []),
          ...
          for (var r = Object.keys(e.metadata), n = 0; n < r.length; n++) {
            ...
            for (var o = 0; o < s.length; o++) {
              ...
              for (var c = 0; c < u.length; c++) {
                var f = u[c];
                this.metadata[i][a][f] == null
                  ? (this.metadata[i][a][f] = e.metadata[i][a][f])
                  : (this.metadata[i][a][f] = this.metadata[i][a][f].concat(
                      e.metadata[i][a][f],
                    ));
              }
            }
    ...
    for (let n = 0; n < r.length; n++) {
      ...
      se(r[n], (o, a, u, c) => {
        ...
        switch ((i[(f = o += s)] || (i[f] = []), a)) {
          ...
          case 1:
            let g = r[n].slice(u, c);
            H(g, lunr.tokenizer.separator, (l, m) => {
                ...
                if (/^[MHIK]$/.test(lunr.segmenter.ctype_(x))) {
                  ...
                  for (let d = 0, y = 0; d < v.length; d++)
                    (i[o] || (i[o] = []),
                      ...
                      e.push(
                        new lunr.Token(v[d].toLowerCase(), {
              ...
              (i[o].push(((u + l) << 12) | ((m - l) << 2) | a),
                e.push(
                  new lunr.Token(g.slice(l, m).toLowerCase(), {
                    position: (o << 20) | (i[o].length - 1),
                  }),
                ));
            });
  ...
  function ce(t) {
    return ue(t, (e) => {
      ...
      for (let { type: i, str: s, start: o, end: a } of n.lexemes)
        switch (i) {
          case 'FIELD':
            ['title', 'text', 'tags'].includes(s) ||
              (e = [e.slice(0, a), ' ', e.slice(a + 1)].join(''));
            break;
          case 'TERM':
            H(s, lunr.tokenizer.separator, (...u) => {
  ...
  function fe(t, e) {
    ...
    for (let s = i.length; s > 0; ) {
      let o = i[--s];
      for (let u = 1; u < n[o]; u++)
        n[o + u] > n[o] - u && (r.add(t.slice(o, o + u)), (i[s++] = o + u));
      let a = o + n[o];
    ...
    constructor({ config: e, docs: r, options: n }) {
      ...
      ((this.map = ie(r)),
        ...
        (this.index = lunr(function () {
          ...
          this.ref('location');
          for (let [o, a] of Object.entries(e.fields))
            this.field(o, B(_({}, a), { extractor: i(o) }));
          for (let o of r) this.add(o, { boost: o.boost });
        })));
    }
    search(e) {
      if (
        ((e = e.replace(new RegExp('\\p{sc=Han}+', 'gu'), (s) =>
          [...fe(s, this.index.invertedIndex)].join('* '),
        )),
        (e = ce(e)),
        !e)
      )
        return { items: [] };
      let r = le(e).filter(
          (s) => s.presence !== lunr.Query.presence.PROHIBITED,
        ),
        n = this.index
          .search(e)
          .reduce((s, { ref: o, score: a, matchData: u }) => {
            let c = this.map.get(o);
            if (typeof c != 'undefined') {
              ((c = _({}, c)), c.tags && (c.tags = [...c.tags]));
              ...
              let g =
                +!c.parent +
                Object.values(f).filter((l) => l).length /
                  Object.keys(f).length;
              s.push(B(_({}, c), { score: a * (1 + K(g, 2)), terms: f }));
            }
            return s;
          }, [])
  ...
  function Fe(t) {
    return W(this, null, function* () {
      switch (t.type) {
        case 0:
          return (yield Ie(t.data.config), (de = new U(t.data)), { type: 1 });
        case 2:
          let e = t.data;
          try {
