...
throw new BadRequestException('Parâmetros de e-mail incompletos');
  ...
  await this.emailModel.create({
    nome_usuario: params.dados.nome,
    email_usuario: params.dados.email,
    texto_digitado: params.dados.mensagem,
    assunto: params.assunto,
    data_envio: new Date(),
  });

  this.logger.log(`E-mail enviado e salvo com sucesso para ${params.to}.`);
